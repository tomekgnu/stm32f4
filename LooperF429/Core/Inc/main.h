...
/* Private defines -----------------------------------------------------------*/
#define audioTimer htim12
#define audioSpi hspi3
...
#define ADCBUSY_Pin GPIO_PIN_2
#define ADCBUSY_GPIO_Port GPIOD
#define DACLD_Pin GPIO_PIN_3
#define DACLD_GPIO_Port GPIOD
#define ADCCS_Pin GPIO_PIN_4
#define ADCCS_GPIO_Port GPIOD
#define DACCS_Pin GPIO_PIN_5
#define DACCS_GPIO_Port GPIOD
