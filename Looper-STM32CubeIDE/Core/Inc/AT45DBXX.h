...
#define AT45DBXX_Enable()        HAL_GPIO_WritePin(AT45DB_CS_GPIO_Port, AT45DB_CS_Pin, GPIO_PIN_RESET);
#define AT45DBXX_Disable()       HAL_GPIO_WritePin(AT45DB_CS_GPIO_Port, AT45DB_CS_Pin, GPIO_PIN_SET);
