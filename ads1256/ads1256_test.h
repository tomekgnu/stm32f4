...
#define SCK_0()		HAL_GPIO_WritePin(SPI2_SCK_GPIO_Port,SPI2_SCK_Pin,GPIO_PIN_RESET)
#define SCK_1()		HAL_GPIO_WritePin(SPI2_SCK_GPIO_Port,SPI2_SCK_Pin,GPIO_PIN_SET)

#define DI_0()	HAL_GPIO_WritePin(SPI2_MOSI_GPIO_Port,SPI2_MOSI_Pin,GPIO_PIN_RESET)
#define DI_1()	HAL_GPIO_WritePin(SPI2_MOSI_GPIO_Port,SPI2_MOSI_Pin,GPIO_PIN_SET)
